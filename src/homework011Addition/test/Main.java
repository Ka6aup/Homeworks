...
import homework011Addition.model.Colors;
...
public class Main {
    static final String DATA_FILE_PATH = "src/homework011Addition/data/cars.TXT";
    static final String OUTOUT_FILE_PATH = "src/homework011Addition/data/output.TXT";
