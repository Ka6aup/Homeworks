...
public class App {
    public static void main(String[] args) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/homework14/input.TXT"));
             PrintWriter writer = new PrintWriter("src/homework14/output.TXT", "UTF-8")) {
