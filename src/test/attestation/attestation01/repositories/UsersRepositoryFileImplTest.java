...
class UsersRepositoryFileImplTest {
    private final String ABSOLUTE_FILE_PATH = "src/attestation/attestation01/Users.TXT";
    ...
    private final UsersRepositoryFileImpl USER_METHODS_STORE = new UsersRepositoryFileImpl();
